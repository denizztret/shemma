...
- **Anchor-bias размещения.** Новый узел со связями ставится в свободный слот, ближайший к центроиду связанных соседей (включая вложенных в контейнеры), а не к центру фрейма — связанные узлы оказываются рядом. Без связей — прежний центр-bias.
